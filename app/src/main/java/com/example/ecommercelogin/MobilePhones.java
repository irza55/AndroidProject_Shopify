...
public class MobilePhones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("   Mobile Phones");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.action_cart:
                Intent intent = new Intent(MobilePhones.this,cart.class);
...
//                        Log.d("enter","enter");
    ...
    private void firebaseSearch(String SearchText){
        ...
        Query query = FirebaseDatabase.getInstance()
                .getReference("Mobile").orderByChild("title").startAt(SearchText).endAt(SearchText+"\uf8ff");
//        Query query = FirebaseDatabase.getInstance()
//                .getReference()
//                .child("Data");
